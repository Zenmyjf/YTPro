...
player.style.transformOrigin="top right";
player.style.pointerEvents="auto";
player.style.cursor="pointer";

/*Tap anywhere on the mini player (except the close button) to restore it*/
if(!player.getAttribute("ytproMiniTap")){
player.setAttribute("ytproMiniTap","true");
player.addEventListener("click", function ytproMiniTapHandler(ev){
if(!isMinimized) return;
if(ev.target && ev.target.id === "ytproMiniClose") return;
minimize(false);
});
}

/*Small close button on the mini player, like the native app's dismiss (x)*/
if(!document.getElementById("ytproMiniClose")){
var closeBtn=document.createElement("div");
closeBtn.setAttribute("id","ytproMiniClose");
closeBtn.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 24 24" width="16"><path fill="#fff" d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>`;
...
player.removeAttribute("ytproMiniTap");
